  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-900 via-violet-800 to-indigo-900 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-4 md:py-8 flex flex-col items-center">
        ...
        {/* Updated date display with new styling */}
        <div className="mb-2">
        ...
        <div className={`text-center mb-8 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-xl md:text-3xl lg:text-4xl font-bold text-white text-center leading-snug px-2">
          ...
          <p className="text-sm md:text-base lg:text-lg text-indigo-200 mt-2 max-w-2xl mx-auto text-center">
          ...
          {loaded && instanceRef.current && (
            <>
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-purple-600/80 hover:bg-purple-600 p-2 rounded-full text-white transition-all duration-300 backdrop-blur-sm"
              >
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-purple-600/80 hover:bg-purple-600 p-2 rounded-full text-white transition-all duration-300 backdrop-blur-sm"
              >
        ...
        <div className={`mb-8 text-center transition-all duration-1000 transform ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`} style={{ transitionDelay: '600ms' }}>
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg px-8 py-4 shadow-lg shadow-green-600/30 animate-pulse">
        ...
        <div className={`mb-16 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '800ms' }}>
          <button 
            ...
            className="group relative bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold text-lg md:text-xl px-10 py-4 rounded-full shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transform hover:scale-105 transition-all duration-300"
          >
            QUERO APROVEITAR
